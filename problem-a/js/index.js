...
let updatedMotto = motto.replace("iSchool", "Information School");
...
let ratio = (updatedMotto.length / motto.length) * 100;
...
let updatedNumbers = numbers.sort();
let median = updatedNumbers[(updatedNumbers.length - 1) / 2];
console.log(median);
...
let circle = {
    cx: 34,
    cy: 43,
    radius: updatedNumbers[updatedNumbers.length - 1]
};
console.log(circle);
